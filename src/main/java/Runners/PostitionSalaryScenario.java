...
public class PostitionSalaryScenario extends AbstractTestNGCucumberTests {
        ...
        public static void afterClass(){
                ...
                Reporter.setSystemInfo("Application Name", "Basqar-Positions Salary Features");
